...
Here's the current method list:
  ...
  present_instance_id     (only works from cloud instances)
  present_security_group  (only works from cloud instances)
  present_instance_role   (only works from cloud instances)
  present_public_hostname (only works from cloud instances)
  database_password       (only works from cloud instances)
  database_username
  database_name
  database_host
  ssh_username
  ssh_password            (only works from cloud instances)
  app_servers
  db_servers
  utilities
  app_master
  db_master
  mysql_command           (only works from cloud instances)
  mysqldump_command       (only works from cloud instances)
  app_slaves
  db_slaves
  solo
  environment_name
